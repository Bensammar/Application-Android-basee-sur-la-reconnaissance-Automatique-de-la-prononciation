...
public class Slide_for_revision extends Activity {

    public static ViewPager viewPager;
    private LinearLayout linearLayout;
    private TextView ndot[];
    private  slideAdapter_for_revision aslideAdapter;
    private Button b10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aslideAdapter = new slideAdapter_for_revision(this);
...
String kaka="";
    ...
    public  void dialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(Slide_for_revision.this);

        View vie = LayoutInflater.from(Slide_for_revision.this).inflate(R.layout.dialog_syllabus, null);
    ...
    public void onBackPressed() {
        Intent i =new Intent(Slide_for_revision.this,MainActivity4.class);
        onDestroy();
        startActivity(i);
    }
}
