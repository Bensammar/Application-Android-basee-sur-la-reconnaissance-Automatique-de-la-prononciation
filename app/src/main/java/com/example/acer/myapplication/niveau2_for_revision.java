...
public class niveau2_for_revision extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue==false) {
                    if (count == 5) {
                        Intent i = new Intent(niveau2_for_revision.this, Slide_for_revision.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau2_for_revision.this,enter_ip_add_chat.class);
                startActivity(i);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau2_for_revision> activityReference;
        SetupTask(niveau2_for_revision activity) {
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("tank")) {
                    ...
                    database.updateDataNiv("niv2cat10",login_activite.nom,Scoreniv2ENG,"eng",difuculte);
