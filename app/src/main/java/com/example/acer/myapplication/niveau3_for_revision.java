...
public class niveau3_for_revision extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue==false) {
                    if (count == 5) {
                        Intent i = new Intent(niveau3_for_revision.this, Slide_for_revision.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau3_for_revision.this,enter_ip_add_chat.class);
                startActivity(i);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau3_for_revision> activityReference;
        SetupTask(niveau3_for_revision activity) {
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("coach")) {
                    ...
                    database.updateDataNiv("niv3cat10",login_activite.nom,scoreniveauENG,"eng",difuculte);
...
//                img.setImageResource(R.drawable.dog_nike);
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File catGrammar = new File(assetsDir,"sport_categorie.gram");
        recognizer.addGrammarSearch(CAT_SEARCH, catGrammar);


        File DogGrammar = new File(assetsDir,"sport_categorie.gram");
        recognizer.addGrammarSearch(DOG_SEARCH, DogGrammar);

        File LionGrammar = new File(assetsDir,"sport_categorie.gram");
        recognizer.addGrammarSearch(LION_SEARCH, LionGrammar);

        File HorseGrammar = new File(assetsDir,"sport_categorie.gram");
        recognizer.addGrammarSearch(HORSE_SEARCH, HorseGrammar);

        File CowGrammar = new File(assetsDir,"sport_categorie.gram");
