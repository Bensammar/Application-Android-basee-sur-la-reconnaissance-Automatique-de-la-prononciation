...
public class slideAdapter_for_revision extends PagerAdapter {
    ...
    public slideAdapter_for_revision(Context context) {
  ...
  //     int a=c.getInt(0);
        ...
        if (position == 0) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i=new Intent(context,niveau1_for_revision.class);
            ...
            if(startActivity.langue==false) {
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        score.setText("" + Slide_for_revision.getscoreimage("sheep"));
                        score2.setText("" + Slide_for_revision.getscoreimage("monkey"));
                        score3.setText("" + Slide_for_revision.getscoreimage("tiger"));
                        score4.setText("" + Slide_for_revision.getscoreimage("panda"));
                        score5.setText("" + Slide_for_revision.getscoreimage("gazelle"));
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_revision.viewPager.setCurrentItem(1);
                                a.cancel();
                            }
                        });
            ...
            if (startActivity.langue == false) {
                final int scoreniv=(Slide_for_revision.getscoreimage("sheep")+Slide_for_revision.getscoreimage("monkey")+Slide_for_revision.getscoreimage("tiger")+Slide_for_revision.getscoreimage("panda")+Slide_for_revision.getscoreimage("gazelle"));
        ...
        if(position==1){
            final   int[] mProgressStatus= {0};
       int scoreniv=(Slide_for_revision.getscoreimage("sheep")+Slide_for_revision.getscoreimage("monkey")+Slide_for_revision.getscoreimage("tiger")+Slide_for_revision.getscoreimage("panda")+Slide_for_revision.getscoreimage("gazelle"));
       ...
       if(scoreniv>=5){
           ...
           imageView.setOnClickListener(new View.OnClickListener() {
               @Override
               public void onClick(View view) {
                   Intent i=new Intent(context,niveau2_for_revision.class);
                   startActivity(context,i,null);
               }
           });
       }
       ...
       if(startActivity.langue==false){
           ...
           flag.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View view) {
                   ...
                   score.setText(""+Slide_for_revision.viewAll("wagon"));
                   score2.setText(""+Slide_for_revision.viewAll("ship"));
                   score3.setText(""+Slide_for_revision.viewAll("tractor"));
                   score4.setText(""+Slide_for_revision.viewAll("canoe"));
                   score5.setText(""+Slide_for_revision.viewAll("tank"));
                   ...
                   next.setOnClickListener(new View.OnClickListener() {
                       @Override
                       public void onClick(View view) {
                           Slide_for_revision.viewPager.setCurrentItem(2);
                           a.cancel();
                       }
                   });
       ...
       if(startActivity.langue==true){
           ...
           flag.setOnClickListener(new View.OnClickListener() {
            ...
            if (startActivity.langue == false) {
                final int scoreniv1=(Slide_for_revision.getscoreimage("wagon")+Slide_for_revision.getscoreimage("ship")+Slide_for_revision.getscoreimage("tractor")+Slide_for_revision.getscoreimage("canoe")+Slide_for_revision.getscoreimage("tank"));
        ...
        if(position==2) {
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_revision.getscoreimage("wagon")+Slide_for_revision.getscoreimage("ship")+Slide_for_revision.getscoreimage("tractor")+Slide_for_revision.getscoreimage("canoe")+Slide_for_revision.getscoreimage("tank"));
            if (scoreniv >= 5) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent(context, niveau3_for_revision.class);
                        startActivity(context, i, null);
                    }
                });
            }
            ...
            if(startActivity.langue==false){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //String sc=   database.getImagescore("cat");
                        score.setText(""+Slide_for_revision.getscoreimage("ball"));
                        score2.setText(""+Slide_for_revision.getscoreimage("stadium"));
                        score3.setText(""+Slide_for_revision.getscoreimage("tribune"));
                        score4.setText(""+Slide_for_revision.getscoreimage("player"));
                        score5.setText(""+Slide_for_revision.getscoreimage("coach"));
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_revision.viewPager.setCurrentItem(3);
                                a.cancel();
                            }
                        });
            ...
            if (startActivity.langue == false) {
                final int scoreniv2=(Slide_for_revision.getscoreimage("ball")+Slide_for_revision.getscoreimage("stadium")+Slide_for_revision.getscoreimage("tribune")+Slide_for_revision.getscoreimage("player")+Slide_for_revision.getscoreimage("coach"));
        ...
        if(position==3) {
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_revision.getscoreimage("ball")+Slide_for_revision.getscoreimage("stadium")+Slide_for_revision.getscoreimage("tribune")+Slide_for_revision.getscoreimage("player")+Slide_for_revision.getscoreimage("coach"));
            if (scoreniv >= 5) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent(context, niveau4_for_revision.class);
                        startActivity(context, i, null);
                    }
                });
            }
            ...
            if(startActivity.langue==false){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //String sc=   database.getImagescore("cat");
                        score.setText(""+Slide_for_revision.getscoreimage("bread"));
                        score2.setText(""+Slide_for_revision.getscoreimage("carrot"));
                        score3.setText(""+Slide_for_revision.getscoreimage("orange"));
                        score4.setText(""+Slide_for_revision.getscoreimage("pizza"));
                        score5.setText(""+Slide_for_revision.getscoreimage("milk"));
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_revision.viewPager.setCurrentItem(4);
                                a.cancel();
                            }
                        });
            ...
            if (startActivity.langue == false) {
               final int scoreniv3=(Slide_for_revision.getscoreimage("bread")+Slide_for_revision.getscoreimage("carrot")+Slide_for_revision.getscoreimage("orange")+Slide_for_revision.getscoreimage("pizza")+Slide_for_revision.getscoreimage("milk"));
        ...
        if(position==4) {
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_revision.getscoreimage("bread")+Slide_for_revision.getscoreimage("carrot")+Slide_for_revision.getscoreimage("orange")+Slide_for_revision.getscoreimage("pizza")+Slide_for_revision.getscoreimage("milk"));
            if (scoreniv >= 5) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent(context, niveau5_for_revision.class);
                        startActivity(context, i, null);
                    }
                });
            }
            if(startActivity.langue==false){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //String sc=   database.getImagescore("cat");
                        score.setText(""+Slide_for_revision.getscoreimage("brush"));
                        score2.setText(""+Slide_for_revision.getscoreimage("pianist"));
                        score3.setText(""+Slide_for_revision.getscoreimage("guitarist"));
                        score4.setText(""+Slide_for_revision.getscoreimage("violinist"));
                        score5.setText(""+Slide_for_revision.getscoreimage("writer"));
            ...
            if (startActivity.langue == false) {
              final int scoreniv4=(Slide_for_revision.getscoreimage("brush")+Slide_for_revision.getscoreimage("pianist")+Slide_for_revision.getscoreimage("guitarist")+Slide_for_revision.getscoreimage("violinist")+Slide_for_revision.getscoreimage("writer"));
