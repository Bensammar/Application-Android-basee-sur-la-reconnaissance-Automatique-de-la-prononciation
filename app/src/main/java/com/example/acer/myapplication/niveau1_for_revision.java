...
public class niveau1_for_revision extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue==false) {
                    if (count == 5) {
                        Intent i = new Intent(niveau1_for_revision.this, Slide_for_revision.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau1_for_revision.this,enter_ip_add_chat.class);
                startActivity(i);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau1_for_revision> activityReference;
        SetupTask(niveau1_for_revision activity) {
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("gazelle")) {
                    ...
                    database.updateDataNiv("niv1cat10",login_activite.nom,Scoreniv2ENG,"eng",difuculte);
...
//                img.setImageResource(R.drawable.dog_nike);
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File sheepGrammar = new File(assetsDir,"sheep.gram");
        recognizer.addGrammarSearch(SHEEP_SEARCH, sheepGrammar);


        File monkeyGrammar = new File(assetsDir,"monkey.gram");
        recognizer.addGrammarSearch(MONKEY_SEARCH, monkeyGrammar);

        File tigerGrammar = new File(assetsDir,"tiger.gram");
        recognizer.addGrammarSearch(TIGER_SEARCH, tigerGrammar);

        File pandaGrammar = new File(assetsDir,"panda.gram");
        recognizer.addGrammarSearch(PANDA_SEARCH, pandaGrammar);

        File gazelleGrammar = new File(assetsDir,"gazelle.gram");
